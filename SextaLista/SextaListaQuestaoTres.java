...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int contador = 0, reprovados = 0, aprovados = 0, emRecuperacao = 0;
        ...
        System.out.println(aprovados + " alunos foram aprovados, " + emRecuperacao + " alunos estão em recuperação e " + reprovados + " foram reprovados.");
    }
}